...
namespace RailwayReservationAndManagementSystem.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClassID,ClassNo,ClassName,Fees,Distances,Status")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClassID,ClassNo,ClassName,Fees,Distances,Status")] Class @class)
        {
            if (ModelState.IsValid)
            {
