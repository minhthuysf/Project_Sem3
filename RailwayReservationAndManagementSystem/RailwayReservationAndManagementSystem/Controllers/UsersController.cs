    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Login(string name, string password)
        {
            if (ModelState.IsValid)
            {
                ...
                var data = db.Users.Where(s => s.Name.Equals(name) && s.Status.Equals(0) && s.Password.Equals(f_password)).FirstOrDefault();
                if (data != null)
                {
                    //add session
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "LoginID,Name,Password,UserType,Status")] User user)
        {
            if (ModelState.IsValid)
            {
                db.Users.Add(user);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoginID,Name,Password,UserType,Status")] User user)
        {
            if (ModelState.IsValid)
            {
